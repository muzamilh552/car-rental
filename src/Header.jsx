        ...
        <>
            <div className="flex justify-around mt-7">
                <div className="flex justify-center gap-6 max-sm:flex-col max-sm:items-center">
                    ...
                    <div className="flex justify-center items-center gap-4 px-6 rounded-3xl border border-gray-200">
                        ...
                        <input className='focus:outline-none focus:ring-0 focus:border-none w-102' type="search" placeholder='Search something here' />
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex justify-center items-center gap-4">
                    ...
                    <img className='w-11 h-11 rounded-full' src={man} alt="" />
                </div>
            </div>
        </>
    );
