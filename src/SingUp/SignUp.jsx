...
// import { EndPoint } from "../Utils/RoutePaths";
...
console.log("postData", postData);
        // setIsLoading(true);
        try {
            const response = await axios.post(BACKENDURL + EndPoint.registeration, postData);
                        ...
                        <form action="" onSubmit={(evt) => {
                            ...
                            <div className="flex justify-between max-sm:flex-col">
                                <div className="flex flex-col mt-4 relative">
                                    ...
                                    <input className='bg-[#F4F2F2] p-2 rounded-xs ' type="text" id='first_name' value={firstName} placeholder='johndoe@gmail.com' onChange={(evt) => {
                                ...
                                <div className="flex flex-col mt-4 relative">
                                    ...
                                    <input className='bg-[#F4F2F2] p-2 rounded-xs' type="text" id='last_name' value={lastName} placeholder='johndoe@gmail.com' onChange={(evt) => {
                            ...
                            <div className="flex flex-col mt-4 relative">
                                <label className='text-[#18345E] font-normal text-base leading-6 font-["Plus_Jakarta_Sans"]' htmlFor="phone">Phone No.</label>
                                <input className='bg-[#F4F2F2] p-2 rounded-xs' type="text" id='phone' value={phone} placeholder='03000000000' onChange={(evt) => {
                            ...
                            <div className="flex justify-between max-sm:flex-col">
                                ...
                                <div className="flex flex-col mt-6 relative">
                                    ...
                                    <input className='bg-[#F4F2F2] p-2 rounded-xs' type="text" id='confpassword' value={confPassword} placeholder='.........' onChange={(evt) => {
                            ...
                            <div className="flex justify-center items-center my-4">
                                <button className='bg-[#FF5C00] flex justify-center items-center rounded-sm  text-[#FFFFFF] text-base font-bold w-full py-2 cursor-pointer' type='submit'>Sign Up</button>
                            </div>
