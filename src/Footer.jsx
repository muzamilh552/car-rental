    ...
    return (
        <>
            <div className="flex flex-col">
                <div className="flex justify-around bg-[#F1EEEE] pt-16 pb-10 max-sm:flex-wrap">
                    <div className="flex flex-col gap-4">
                        <h1 className='text-[#FF5C00] text-[32px] font-bold font-["Plus_Jakarta_Sans"] '>Showroom</h1>
                        <p className='font-medium text-[#13131399] text-base font-["Plus_Jakarta_Sans"] '>Our vision is to provide convenience and help increase your sales business.</p>
                    </div>
                ...
                <div className=" flex justify-between px-20 pt-7 pb-12 bg-[#F1EEEE]">
                    <div className="flex">
